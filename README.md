...
- **Languages:** Java, C, Typescript, Python, Swift, Rust, ...
- **Frontend:** React, VueJS, Angular
- **Backend / APIs:** SpringBoot, FastAPI
- **DevOps / Deployment:** Docker, CI/CD, Kubernetes, Proxmox, Grafana, ...
- **Other:** Agentic E2E Testing, Cybersecurity, Machine Learning, Robotics, Hardware


## 🚀 What I’m Working On  
- **U_Plan** – University Management Portal [uplan.twks.net](https://uplan.twks.net)
- **Pensuite** – CLI based modular Webpenetration tool
- many more...


## 📂 Portfolio & Projects  
Check out my portfolio at [tobiwn.me](https://tobiwn.me) — there you’ll find a curated selection of projects I’ve built, including descriptions, tech stack, live demos, and code samples.  

## 📫 Get in Touch  
- 🌐 Portfolio / Blog: [tobiwn.me](https://tobiwn.me)  
- 📧 Email: github@twks.net
- 💼 LinkedIn: [in/klingenberg](https://linkedin.com/in/klingenberg)  

---

Thanks for stopping by. Feel free to browse my repositories, open issues, or reach out!  
